...
DUK_LOCAL void duk__create_arguments_object(duk_hthread *thr,
	...
	/* [ ... func(@idx_func) this(@idx_func+1) arg1 ... argN envobj ]
	 * [ arg1 ... argN envobj ] (for tailcalls)
	 */
...
DUK_LOCAL void duk__call_setup_act_not_tailcall(duk_hthread *thr, duk_small_uint_t call_flags, duk_idx_t idx_func, duk_hobject *func, duk_size_t entry_valstack_bottom_byteoff, duk_idx_t *out_nargs, duk_idx_t *out_nregs, duk_size_t *out_vs_min_bytes, duk_activation **out_act) {
	duk_activation *act;
...
DUK_LOCAL duk_int_t duk__handle_call_raw(duk_hthread *thr,
	...
	if (use_tailcall) {
		...
		duk__call_setup_act_not_tailcall(thr, call_flags, idx_func, func, entry_valstack_bottom_byteoff, &nargs, &nregs, &vs_min_bytes, &act);
		idx_args = idx_func + 2;
	}
